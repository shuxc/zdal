...
public abstract class DummyTResultSet implements ResultSet {
    ...
    /**
     * bug fix by shenxun : 鍘熸潵浼氬彂鐢熶竴涓儏鍐靛氨鏄鏋淭Statement璋冪敤浜哻lose()鏂规硶
     * 鑰屾湰韬叾绠＄悊鐨凾ResultSet娌℃湁closed鏃跺�欍�傚閮ㄤ細浣跨敤iterator鏉ラ亶鍘嗘瘡涓�涓�
     * TResultSet锛岃皟鐢ㄥ叧闂殑鏂规硶锛屼絾鍥犱负TResultSet鐨刢lose鏂规硶浼氬洖璋�
     * TStatement閲岄潰鐢ㄤ簬鍒涘缓iterator鐨凷et<ResultSet>瀵硅薄锛屽苟浣跨敤remove鏂规硶銆�
     * 杩欏氨浼氭姏鍑轰竴涓猚oncurrentModificationException銆�
     * 
     * @param removeThis
     * @throws SQLException
     */
